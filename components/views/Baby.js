...
export default st => html`
  ...
  <form id="BabyRomper" method="POST" action="">
    <div class="card">
      <img src="${baby}" alt="Romper" style="width:50%" />
      <p>Romper</p>
      ...
      <div>
        ...
        <select id="color" name="color">
          ...
          <option value="${st.Romper[64].color}">${st.Romper[64].color}</option>
          <option value="${st.Romper[69].color}">${st.Romper[69].color}</option>
          <option value="${st.Romper[74].color}">${st.Romper[74].color}</option>
        </select>
        <input
          type="hidden"
          name="type"
  ...
  <form id="BabySweaters" method="POST" action="">
    <div class="card">
      <img src="${sweater}" alt="sweater" style="width:60%" />
      <p>Sweater</p>
  ...
  <form id="BabyPants" method="POST" action="">
    <div class="card">
      <img src="${pants}" alt="pants" style="width:60%" />
      <p>Pants</p>
  ...
  <form id="BabyTshirt" method="POST" action="">
    <div class="card">
      <img src="${TShirt}" alt="sweater" style="width:60%" />
      <p>Sweater</p>
